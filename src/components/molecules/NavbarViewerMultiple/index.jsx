...
import {
  ...
  TabsContainer, Tab, AddTab, NavbarArrow,
} from './styles'

function NavbarViewerMultiple({ url, highlightTextMode, isEditable, note, ...props }) {
  const router = useRouter()
  const [infoDialogOpen, setInfoDialogOpen] = useState(false)

  const { content, saved } = props.resource
  ...
  return (
    <Container>
      ...
      <RightContainer>
        ...
        <Tooltip label="Expand article">
          <NavbarIcon icon="expand" onClick={onArticleExpandClick} />
        </Tooltip>
        {props.showNoteIcon && (
